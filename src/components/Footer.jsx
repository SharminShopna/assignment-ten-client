...
const Footer = () => {
  ...
  <aside>
    ...
    <h2 className='text-3xl text-blue-900 font-medium'>Sport Equipment</h2>
    <p>
    Gear up with the best! Shop the top sport<br></br> equipment for all your needs.
    </p>
  </aside>
  <nav>
    ...
    <a className="link link-hover">Cycling</a>
  </nav>
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">Multi Sports</a>
...
<footer className="footer footer-center bg-base-200 text-base-content p-4">
  <aside>
    <p>Copyright© 2024 SportEquipment - All rights reserved by sport Ltd.</p>
  </aside>
</footer>
    </>
  );
