  ...
  return (
    <>
      ...
      <div className="w-11/12 mx-auto">
        ...
        <div
          className={`card md:card-side shadow-xl my-32 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-base-100'}`}
        >
          <figure>
          ...
          <div className="card-body">
            ...
            <p className="flex gap-1 text-lg items-center text-center">
              <MdOutlineCategory /> {category}
            </p>
            <p className="flex items-center gap-1">
              <FaAudioDescription size={32} /> {description}
            </p>
            ...
            <div className="card-actions justify-start">
              <Link to="/allData" className="btn bg-blue-900 text-white w-72">
                Go Back
              </Link>
            </div>
          </div>
